                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="account-box">
                            <div class="account-logo-box">
                                ...
                                <h5 class="text-uppercase mb-1 mt-4 text-center">Sign Up by Invitation (Step 1)</h5>
                            ...
                            <div class="account-content mt-4">
                                <form class="form-horizontal" method="POST" action="{{route('create.invited.client')}}">
                                    ...
                                    <input type="hidden" name="invitedId" value="{{$userId}}">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="company_name">Company Name</label>
                                            <input class="form-control" type="text" id="company_name"  readonly name="company_name" value="{{$userProfile->company}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="company_phone">Company Phone</label>
                                            <input class="form-control" type="text" id="company_phone"  readonly name="company_phone" value="{{$userProfile->phone}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
