                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="account-box">
                            <div class="account-logo-box">
                                ...
                                <h5 class="text-uppercase mb-1 mt-4 text-center">Company / Applicant Sign Up</h5>
                                ...
                                <form class="form-horizontal" method="POST" action="{{route('register.company')}}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="text" id="company_name" required="required" name="company_name" placeholder="Enter Company Name" value="{{old('company_name')}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="company_phone">Company Phone</label>
                                            <input class="form-control" type="text" id="company_phone" required="required" name="company_phone" placeholder="Enter Company Name" value="{{old('company_phone')}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
