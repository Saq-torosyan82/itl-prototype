            ...
            <div class="card-body p-4">
                ...
                <div class="account-box">
                    <div class="account-logo-box">
                        ...
                        <p class="mb-0">Get access to our job seeker panel</p>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="account-content mt-4">
                        <form class="form-horizontal" method="POST" action="{{route('register')}}">
                            @csrf
                            <input type="hidden" name="registration_type" value="applicant">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="text-center">
                                    <a href="{{ route('social.register', ['driver' => 'facebook', 'user_type' => 'applicant']) }}" style="color: white;">
                                        <button type="button" class="btn mr-1 btn-facebook waves-effect waves-light">
                                            <i class="fab fa-facebook-f"></i>
                                        </button>
                                    </a>
                                    <a href="{{ route('social.register', ['driver' => 'google', 'user_type' => 'applicant']) }}" style="color: white">
                                        <button type="button" class="btn mr-1 btn-googleplus waves-effect waves-light">
                                            <i class="fab fa-google"></i>
                                        </button>
                                    </a>
                                    <a href="{{ route('social.register', ['driver' => 'linkedin', 'user_type' => 'applicant']) }}" style="color: white">
                                        <button type="button" class="btn mr-1 btn-linkedin waves-effect waves-light">
                                            <i class="fab fa-linkedin-in"></i>
                                        </button>
                                    </a>
                                    <a href="{{ route('social.register', ['driver' => 'apple', 'user_type' => 'applicant']) }}" style="color: white">
                        ...
                        <div class="row mt-4 pt-2">
                            <div class="col-sm-12 text-center">
                                <p class="text-muted">Already have an account?  <a href="{{route('login-client')}}" class="text-dark ml-1"><b>Sign In</b></a></p>
                            </div>
                        </div>
