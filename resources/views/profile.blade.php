...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label" for="address">Address 1</label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label" for="address-2">Address 2</label>
                                                <input type="text" id="address-2" name="secondary_address" class="form-control"  value="{{$profile->secondary_address ? $profile->secondary_address : old('secondary_address') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label" for="country">Towns in IE </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-form-label" for="handling-certificate-1">Manual Handling Certificate</label>
                                                    <div class="row mt-1">
                                                        <div class="col-6">
                                                            <input type="radio" name="certificate" value="1" id="handling_certificate-1"@if ($profile->certificate == 1) checked="checked" @endif/>
                                                            <label for="handling-certificate-1" class="ml-1">Yes</label>
                                                        </div>
                                                        <div class="col-6">
                                                            <input type="radio" name="certificate" value="0" id="handling_certificate-0"@if ($profile->certificate == 0 || $profile->certificate == null) checked="checked" @endif/>
                                                            <label for="handling-certificate-0" class="ml-1">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
...
{{--                                        <div class="col-lg-4 col-md-6 col-sm-12">--}}
{{--                                            <div class="form-group">--}}
{{--                                                    <a id="previewA" href="{{ route('preview-profile-inf') }}">--}}
{{--                                                        <div class="btn btn-md mt-4 btn-primary waves-effect waves-light" >--}}
{{--                                                             preview profile--}}
{{--                                                        </div>--}}
{{--                                                    </a>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                ...
                                @if (Auth::user()->hasRole('applicant'))
                                    <div id="documents-section" class="row" data-type="cover_letter">
                                    @include('components.documents.main', [
                                        'doc_type'       => "cover_letter",
                                        'header_title'   => "My Cover Letters",
                                        'upload_btn_txt' => "Upload New Cover Letter",
                                    ])
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    <label class="col-form-label" for="manual-handling-certificate">Manual Handling Certificate</label>
                                    <p class="text-muted">Dummyfile.pdf</p>
                                    <div>
                                        <button type="button" class="btn btn-md btn-primary waves-effect waves-light" disabled> Coming Soon</button>
                                    </div>
                                </div>
                            </div>
                        </div>
